...
movie <- read.csv("~/Documents/GitHub/imdb-prediction/IMDB_data_Fall_2023.csv")
movie_final=movie
##############
#Country
#############
...
######################################################################
movie_test=read.csv("~/Documents/GitHub/imdb-prediction/test_data_IMDB_Fall_2023.csv")
